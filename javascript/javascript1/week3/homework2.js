...
const timeToArrive = (obj) => {
  let result = obj.destinationDistance / obj.speed;
  let minutes = (result - parseInt(result)) * 60;
  return `${Math.floor(result)} hours and ${minutes.toFixed()} minutes`;
};
